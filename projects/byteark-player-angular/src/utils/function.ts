...
export const defaultCreatePlayerFunction: CreatePlayerFunction = (node, options, onReady) => {
...
export const defaultSetupPlayerFunction: SetupPlayerFunction = async (options, loaderFunction, loadPluginOptions) => {
